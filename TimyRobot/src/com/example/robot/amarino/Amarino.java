...
public class Amarino {
	 ...
	 * This method uses {@link com.example.robot.amarino.AmarinoIntent#ACTION_CONNECT} to initiate a connection.
	 * 
	 ...
	 * <ul>
     *   <li><em>{@link com.example.robot.amarino.AmarinoIntent#ACTION_CONNECTED}</em></li>
     *   <li><em>{@link com.example.robot.amarino.AmarinoIntent#ACTION_DISCONNECTED}</em></li>
     *   <li><em>{@link com.example.robot.amarino.AmarinoIntent#ACTION_CONNECTION_FAILED}</em></li>
     *   <li><em>{@link com.example.robot.amarino.AmarinoIntent#ACTION_PAIRING_REQUESTED}</em></li>
     * </ul>
	 * 
	 ...
	 * <a href="http://developer.android.com/reference/android/content/BroadcastReceiver.html">BroadcastReceiver</a>
	 * for the {@link com.example.robot.amarino.AmarinoIntent#ACTION_DISCONNECTED} intent.
	 * 
	 * @param context the context
